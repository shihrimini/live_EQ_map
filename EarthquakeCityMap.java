 ...
 * UC San Diego Intermediate Software Development MOOC
**/
public class EarthquakeCityMap extends PApplet {
	...
	private void sortAndPrint(int numToPrint){
		...
		for(Marker m: quakeMarkers){
			quakeList.add((EarthquakeMarker)m);
		}
		Collections.sort(quakeList);
		int actualNumToPrint = (numToPrint >= quakeList.size()? quakeList.size(): numToPrint);
